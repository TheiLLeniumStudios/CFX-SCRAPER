...
function _RequestSearch(uuid) {
    ...
    log(`Converted Link: https://steamcommunity.com/profiles/${_DecimalToUUID}`); // I dont want to check if a user exists because that requires effort and I have no effort lol
    _exit()
}
