...
def _searchServerName():
    ...
    os.system('cls || clear')
    os.system("node Javascript/cfxScrape.js " + getRegex + " undefined " + " -Sn") # Server Name
def _searchServerID():
    getRegex234 = input("Enter the server ID: ")
    os.system('cls || clear')
    os.system("node Javascript/cfxID.js " + getRegex234+ " undefined " + " -Sd") # Server ID
def _searchServerResource():
    getRegex = input("Enter the server resource name: ")
    os.system('cls || clear')
    os.system("node Javascript/cfxScrape.js " + getRegex+ " undefined " + " -Rn") # Server Resource Name
def _searchServerFramework():
    print("[1] ESX")
    print("[2] vRP")
    print("[3] QBCore")
    getRegex = input("Enter the server framework: ")
    if getRegex == "1":
        os.system('cls || clear')
        os.system("node Javascript/cfxScrape.js esx  undefined " + " -RnF")
    elif getRegex == "2":
        os.system('cls || clear')
        os.system("node Javascript/cfxScrape.js vrp undefined " + " -RnF")
    elif getRegex == "3":
        os.system('cls || clear')
        os.system("node Javascript/cfxScrape.js qb undefined " + " -RnF")
    else:
...
def _searchServerPlayerCount():
    ...
    os.system('cls || clear')
    os.system("node Javascript/cfxScrape.js " + getMin + " " + getMax + " -Pc") # Server Player Count
def _searchBooleanOneSync():
    getRegex = input("OneSync [true/false]: ")
    os.system('cls || clear')
    os.system("node Javascript/cfxScrape.js " + getRegex + " undefined " + " -O") # OneSync
def _searchBooleanScriptHook():
    getRegex = input("ScriptHook [true/false]: ")
    os.system('cls || clear')
    os.system("node Javascript/cfxScrape.js " + getRegex+ " undefined " + " -S") # ScriptHook
def _searchBuildVersion():
    getRegex = input("Enter the build version: ")
    os.system('cls || clear')
    os.system("node Javascript/cfxScrape.js " + getRegex+ " undefined " + " -B") # Build Version
def _searchHostType():
    print("[1] Linux")
    print("[2] Windows")
    ...
    if getRegex == "1":
        os.system('cls || clear')
        os.system("node Javascript/cfxScrape.js linux" + " undefined " + " -H") # Host Type
    elif getRegex == "2":
        os.system('cls || clear')
        os.system("node Javascript/cfxScrape.js windows"+ " undefined " + " -H") # Host Type
def _searchSupportType():
    ...
    if getRegex == "1":
        os.system('cls || clear')
        os.system("node Javascript/cfxScrape.js supported"+ " undefined " + " -Su") # Support Type
    elif getRegex == "2":
        os.system('cls || clear')
        os.system("node Javascript/cfxScrape.js end_of_support"+ " undefined " + " -Su") # Support Type
def _searchForumID():
    getRegex = input("Enter the forum ID: ")
    os.system('cls || clear')
    os.system("node Javascript/cfxForum.js " + getRegex+ " undefined " + " -F") # Forum ID
def _searchSteamDecToHex(): # Easy way to convert the steam decimal ID to a link [Base16 Conversion] :D
    ...
    os.system('cls || clear')
    os.system("node Javascript/cfxSteam.js " + getRegex+ " undefined " + " -D") # Steam Decimal to Hex
def _runPlayerNameSearch():
    getRegex = input("Enter the player name: ")
    os.system('cls || clear')
    os.system("node Javascript/cfxScrape.js " + getRegex+ " undefined " + " -Pn") # Player Name
def _runPlayerIdentifierSearch():
    getRegex = input("Enter the player identifier: ")
    os.system('cls || clear')
    os.system("node Javascript/cfxScrape.js " + getRegex+ " undefined " + " -Pi") # Player Identifier
def _searchServerOwnerCheck():
    os.system('cls || clear')
    os.system("node Javascript/cfxScrape.js undefined undefined " + " -Co") # Server Owner
def _scrapeEverything():
    os.system('node Javascript/cfxScrape.js'+ " undefined undefined " + " -Sq") # Scrape Everything
def _installNodeJS():
   os.system('py Javascript/installPackages.py')
...
_ChoicesArray = [  #Low-key pretty smart for doing this method instead of use if-else statements lmao
    ...
    {"Choice": "10", "Type": "SERVER", "Name": "Check Server Framework", "Function": _searchServerFramework}, 
    {"Choice": "11", "Type": "SERVER", "Name": "Support Type Search", "Function": _searchSupportType},
    {"Choice": "12", "Type": "PLAYER", "Name": "Forum ID Search", "Function": _searchForumID},
    {"Choice": "13", "Type": "PLAYER", "Name": "Steam Decimal to Hex Search", "Function": _searchSteamDecToHex},
    {"Choice": "14", "Type": "PLAYER", "Name": "Name Search", "Function": _runPlayerNameSearch},
    {"Choice": "15", "Type": "PLAYER", "Name": "Identifier Search", "Function": _runPlayerIdentifierSearch},
    {"Choice": "16", "Type": "ALL_EN", "Name": "Everything", "Function": _scrapeEverything},
    {"Choice": "17", "Type": "NodeJS", "Name": "Install NodeJS Packages", "Function": _installNodeJS}
...
def _initChoosen():
    try:
        global CurrentIssue
        os.system("title " + "CFX.re Scraper - Created by Rabbit.hak5 / K3YOMI@Github")
        os.system('cls || clear')
        print(_Logo_)
        print(f"[#]\t[Type]\t\t[Action]")
        print("━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━")
